  ...
  private MealControlDTO buildMealControlDTO(List<Food> foods, LocalDate referenceDate) {
    ...
    return MealControlDTO.builder()
        ...
        .carbohydratePercentage(
            MacrosCalculator.getPercentage(userCarbohydrateTarget, carbohydrate.isEmpty() ? carbohydrate.get() : 0F))
        .proteinPercentage(
            MacrosCalculator.getPercentage(userProteinTarget, protein.isEmpty() ? protein.get() : 0F))
        .fatPercentage(
